...
describe("GeographicCoordinateConverter conversion suite", () => {
    ...
    it("should convert to degree minutes array (south, west)", () => {
        expect(new GeographicCoordinateConverter(-36.01011, -2.34856).toDegreeMinutesArray()).toEqual(["36º 00.607' S", "002º 20.914' W"]);
    });
    ...
    it("should convert to degree minutes seconds array (south, west)", () => {
        expect(new GeographicCoordinateConverter(-36.01011, -2.34856).toDegreeMinutesSecondsArray()).toEqual(["36º 00' 36.4'' S", "002º 20' 54.8'' W"]);
    });
